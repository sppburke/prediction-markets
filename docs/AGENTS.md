...
- Do not size fresh-wallet first-trade signals until proxy-wallet/funder/collateral mapping is proven from public data and the mode has its own paper/backtest validation (per `19-` "Promotion ladder").

...
# - Drawdown stops + latency kill switch consume exact owner snapshots derived from synchronized
#   financial Finals, portfolio marks, and recorded latency samples. Missing inputs fail closed.
...
8. Require fresh, unambiguous resolver and venue evidence before preparation; missing evidence fails closed at its semantic owner.

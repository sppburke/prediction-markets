...
- **run28 (2026-07-03, operator-ordered)** is classified under this taxonomy as
  bench-composition/descriptive evidence: results and a *proposed* pre-T0 amendment to
  §2's online_weighting arm are in `docs/33-RUN28-2026-WEEKLY-BAKEOFF-RESULTS.md`. This
  registration is unchanged until that amendment is explicitly adopted here.

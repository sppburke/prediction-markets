...
//!
//! Failure policy: the leaderboard and Radion sources propagate errors (fatal to
//! `pe-bootstrap all`). The datadash source **soft-fails** — any
...
//! (e.g. a broken cache) still propagate.

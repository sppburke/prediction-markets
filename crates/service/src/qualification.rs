                ...
                match (prepared_payload, result) {
                    (
                        ...
                        completed_fills.push(CompletedFill {
                            ...
                            economic_version: economic.version,
                        });
                    }
                    (
                        FinancialPayload::Resolution {
...
fn bind_final_receipts(
    ...
    for decision in decisions {
        ...
        if decision_key != prepared_key
            ...
            || continuation.applied_configuration_hash != fill.applied_configuration_hash
            || continuation.applied_configuration_hash != started.hot_config_hash
            || u32::from(fill.economic_version) != started.financial_semantic_version
        {
            return insufficient(
